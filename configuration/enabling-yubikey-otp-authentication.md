...
* 为了生成 API 密钥或在 OTP 服务器上使用 YubiKey，必须对其进行注册。在 [YubiKey 个性化工具](https://www.yubico.com/products/services-software/personalization-tools/use/)（或 YubiKey Manager）中配置好你的密钥后，然后在[此处](https://upload.yubico.com/)这里使用默认服务器注册。
